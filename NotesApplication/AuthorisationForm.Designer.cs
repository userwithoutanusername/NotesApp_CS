namespace NotesApplication
{
    partial class AuthorisationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            LoginBTN.FlatAppearance.MouseDownBackColor = Color.Lime;
            LoginBTN.FlatStyle = FlatStyle.Flat;
            LoginBTN.Font = new Font("OCR A Extended", 22.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            LoginBTN.ForeColor = Color.Lime;
            LoginBTN.Location = new Point(42, 217);
            LoginBTN.Name = "LoginBTN";
            LoginBTN.Size = new Size(319, 70);
            LoginBTN.TabIndex = 2;
            LoginBTN.Text = "Login";
            ...
            RegBTN.Location = new Point(42, 293);
            RegBTN.Name = "RegBTN";
            ...
            Text = "Authorisation";
            MouseDown += AuthorisationForm_MouseDown;
            MouseMove += AuthorisationForm_MouseMove;
            ResumeLayout(false);
            PerformLayout();
        }
